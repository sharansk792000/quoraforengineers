...
<html>
    ...
    <body id="_1">
        ...
        <!-- content -->
        <div id="content" style="background-image:url('images\banner.jpg')">
            <div id="searchbox">
                <center>
                    <div class="heading">
                        <h5 class="logo"><div id="i">Q</div><div id="cir">i</div><div id="ntro">uora for Engineers</div></h5>
                        <p id="tag-line"> Where Questions are thenselves the answer </p>
                    </div>
